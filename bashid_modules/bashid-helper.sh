...
check_pkg () {
    ...
    if [[ $? -eq 0 ]]; then
        hideSpin 1
        showSpin 'create public directory'
        xterm -geometry 96x25+0+0 -title "Github submodule" -e git submodule add -b master https://github.com/bashidorg/bashidorg.github.io.git public
